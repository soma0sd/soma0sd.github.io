...
// -----------------------------------------------------------------------------
function localizeTime(elem: HTMLTimeElement): void {
...
// -----------------------------------------------------------------------------
function formatNumber(elem: HTMLElement): void {
...
const THEME_VIEW: Record<ThemeMode, ThemeView> = {
...
function renderThemeButton(button: HTMLButtonElement, mode: ThemeMode): void {
...
// -----------------------------------------------------------------------------
function setupSectionHighlight(): void {
    if (!("IntersectionObserver" in window)) {
        return;
    }

    const links = Array.from(document.querySelectorAll<HTMLAnchorElement>(".site-nav__links a"));
    const watched: { id: string; section: Element; link: HTMLAnchorElement }[] = [];
...
document.querySelectorAll<HTMLTimeElement>("time[datetime]").forEach(localizeTime);
document.querySelectorAll<HTMLElement>("[data-number]").forEach(formatNumber);
setupThemeToggle();
